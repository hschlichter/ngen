...
ifeq ($(UNAME_S),Darwin)
	...
	INCLUDE = -Isrc -Isrc/rhi -Isrc/rhi/vulkan -Isrc/renderer -Isrc/scene -Isrc/ui -Iexternal/glm -Iexternal/cgltf -Iexternal/stb -Iexternal/imgui -Iexternal/imgui/backends -I$(VULKAN_SDK)/include
	...
	INCLUDE = -Isrc -Isrc/rhi -Isrc/rhi/vulkan -Isrc/renderer -Isrc/scene -Isrc/ui -Iexternal/glm -Iexternal/cgltf -Iexternal/stb -Iexternal/imgui -Iexternal/imgui/backends
	LDINCLUDE =
	GLSLC = glslc
endif
