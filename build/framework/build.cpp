...
std::expected<void, Error> NinjaBackend::emit(const Graph& graph, Target& desired, Path output) const {
...
std::expected<void, Error> NinjaBackend::build(const Graph& graph, Target& desired, const ParsedTarget& parsed) const {
